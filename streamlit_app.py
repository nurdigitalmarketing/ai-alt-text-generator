...
st.set_page_config(layout=layout, page_title="AI Alt Text Generator", page_icon="🔌")
...
with tab1:
    # Sidebar content
    st.sidebar.image("https://raw.githubusercontent.com/nurdigitalmarketing/previsione-del-traffico-futuro/9cdbf5d19d9132129474936c137bc8de1a67bd35/Nur-simbolo-1080x1080.png", width=290)
    st.sidebar.markdown("")
...
with tab2:
    st.write("""
    ## About this app
    * L'applicazione consente di caricare più immagini, selezionare la lingua del testo alternativo e generare il codice HTML con il testo alternativo.
    * I risultati possono essere esportati in un file Excel.
    * Puoi facilmente connetterti all'API di Google Search Console e visualizzare i dati.
    * Raggiungi il limite massimo di righe con un solo clic!
    
    #### Domande, commenti, o segnalazione di bug?
    * Se hai domande o commenti, contatta [me](https://twitter.com/DataChaz) oppure chiedi alla [community di Streamlit](https://discuss.streamlit.io).
    * Se trovi un bug, per favore segnalalo su [Github](https://github.com/CharlyWargnier/google-search-console-connector/pulls).
